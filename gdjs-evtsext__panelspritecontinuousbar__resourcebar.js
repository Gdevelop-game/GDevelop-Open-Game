...
gdjs.evtsExt__PanelSpriteContinuousBar__ResourceBar.ResourceBar.getSharedData = function(instanceContainer, behaviorName) {
  if (!instanceContainer.__ResourceBarSharedData) {
    const initialData = instanceContainer.getInitialSharedDataForBehavior(
      behaviorName
    );
    instanceContainer.__ResourceBarSharedData = new gdjs.evtsExt__PanelSpriteContinuousBar__ResourceBar.ResourceBar.SharedData(
      initialData
    );
  }
  return instanceContainer.__ResourceBarSharedData;
}
...
gdjs.registerBehavior("::ResourceBar", gdjs.evtsExt__PanelSpriteContinuousBar__ResourceBar.ResourceBar);
