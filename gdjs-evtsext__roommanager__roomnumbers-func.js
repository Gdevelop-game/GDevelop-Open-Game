...
if (typeof gdjs.evtsExt__RoomManager__roomNumbers !== "undefined") {
  gdjs.evtsExt__RoomManager__roomNumbers.registeredGdjsCallbacks.forEach(callback =>
...
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = gdjs.evtTools.variable.getVariableChildCount(runtimeScene.getGame().getVariables().get("_RoomManager__RoomsNumber")); }}}
...
gdjs.evtsExt__RoomManager__roomNumbers.registeredGdjsCallbacks = [];