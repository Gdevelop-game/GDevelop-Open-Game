...
gdjs.evtsExt__PanelSpriteSlider__ButtonFSM.ButtonFSM.getSharedData = function(instanceContainer, behaviorName) {
  if (!instanceContainer.__ButtonFSMSharedData) {
    const initialData = instanceContainer.getInitialSharedDataForBehavior(
      behaviorName
    );
    instanceContainer.__ButtonFSMSharedData = new gdjs.evtsExt__PanelSpriteSlider__ButtonFSM.ButtonFSM.SharedData(
      initialData
    );
  }
  return instanceContainer.__ButtonFSMSharedData;
}
...
gdjs.registerBehavior("::ButtonFSM", gdjs.evtsExt__PanelSpriteSlider__ButtonFSM.ButtonFSM);
