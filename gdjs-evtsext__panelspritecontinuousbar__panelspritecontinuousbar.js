...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(28144588);
}
}
if (isConditionTrue_0) {
...
gdjs.registerObject("::PanelSpriteContinuousBar", gdjs.evtsExt__PanelSpriteContinuousBar__PanelSpriteContinuousBar.PanelSpriteContinuousBar);
